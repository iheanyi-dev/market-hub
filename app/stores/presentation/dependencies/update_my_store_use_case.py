"""
Dependency provider for UpMyStore.
"""
...
def get_update_my_store_use_case(
    db_session: AsyncSession = Depends(get_db_session),
) -> UpdateMyStoreUseCase:
    """
    Create an UpdateMyStoreUseCase instance.
    ...
    Returns:
        Configured UpdateMyStoreUseCase.
    """
